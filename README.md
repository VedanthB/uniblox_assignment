...
- [API Endpoints](#api-endpoints)
    ...
    - [Cart & Checkout APIs](#cart--checkout-apis)
...
## Deployment
ShopEasy can be deployed on Vercel with minimal configuration. Simply connect your Git repository to Vercel and configure the environment variables in the Vercel dashboard. For additional details, refer to the [Next.js Deployment Documentation](https://nextjs.org/docs/deployment).
